package com.uchump.prime.Metatron.Lib._RelaxngDatatype.helpers;

import com.uchump.prime.Metatron.Lib._RelaxngDatatype.*;

/**
 * Dummy implementation of {@link DatatypeBuilder}.
 * 
 * This implementation can be used for Datatypes which have no parameters. Any
 * attempt to add parameters will be rejected.
 * 
 * <p>
