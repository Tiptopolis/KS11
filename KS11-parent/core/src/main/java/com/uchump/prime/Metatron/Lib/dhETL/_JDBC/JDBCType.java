...
final public class JDBCType {
    ...
    public static aMultiMap<Integer, Class> dbJava;
    public static aMultiMap<Class, Integer> javaDb;

    static {
        javaDb = new aMultiMap<Class, Integer>();
        ...
        dbJava = new aMultiMap<Integer, Class>();
