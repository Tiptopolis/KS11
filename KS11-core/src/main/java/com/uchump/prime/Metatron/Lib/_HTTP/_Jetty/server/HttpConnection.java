...
import com.uchump.prime.Metatron.Lib._HTTP._Jetty.io.EofException;
...
import com.uchump.prime.Metatron.Lib._HTTP._Jetty.io.WriteFlusher;
...
public class HttpConnection extends AbstractConnection implements Runnable, HttpTransport, WriteFlusher.Listener, Connection.UpgradeFrom, Connection.UpgradeTo
{
    ...
    @Override
    public void push(com.uchump.prime.Metatron.Lib._HTTP._Jetty.http.MetaData.Request request)
    {
