...
public interface Callback extends Invocable {
	 ...
	 * implementation without incurring in the cost of allocating a new Adapter
	 * object.
	 */
	 ...
	 * when the CompletableFuture completes exceptionally, this callback is failed.
	 * </p>
	 *
	...
	/**
	 * Creates a callback with the given InvocationType from the given success and
	 * failure lambdas.
	 *
	...
	/**
	 * <p>
	 * Creates a Callback with the given {@code invocationType}, that runs the given
	 * {@code Runnable} when it succeeds or fails.
	 * </p>
	 *
	 * @param invocationType the invocation type of the returned Callback
	 * @param completed      the Runnable to run when the callback either succeeds
	 *                       or fails
	...
	/**
	 * Creates a nested callback that runs completed after completing the nested
	 * callback.
	 *
	...
	/**
	 * Creates a nested callback that runs completed before completing the nested
	 * callback.
	 *
	 * @param callback  The nested callback
	 * @param completed The completion to run before the nested callback is
	 *                  completed. Any exceptions thrown from completed will result
	 *                  in a callback failure.
	 * @return a new callback.
	 */
	...
	/**
	 * Creates a nested callback which always fails the nested callback on
	 * completion.
	 *
	 * @param callback The nested callback
	 * @param cause    The cause to fail the nested callback, if the new callback is
	 *                 failed the reason will be added to this cause as a suppressed
	 *                 exception.
	 * @return a new callback.
	 */
	...
	/**
	 * Creates a callback which combines two other callbacks and will succeed or
	 * fail them both.
	 * 
	...
	/**
	 * <p>
	 * A Callback implementation that calls the {@link #completed()} method when it
	...
	/**
	 * Nested Completing Callback that completes after completing the nested
	 * callback
	 */
