...
import static com.uchump.prime.Metatron.Lib.dhETL.Util.StringType.*;
...
import com.uchump.prime.Metatron.Lib.dhETL.Util.StringType;
...
public class CSVReader implements _Reader<Row> {
