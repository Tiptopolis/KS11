package com.uchump.prime.Metatron.Lib._HTTP._Spark.utils.decoding;
...
public class TypeUtil {
    ...
    /* ------------------------------------------------------------ */
    private static final aMultiMap<String, Class<?>> name2Class = new aMultiMap<>();
    ...
    /* ------------------------------------------------------------ */
    private static final aMultiMap<Class<?>, String> class2Name = new aMultiMap<>();
    ...
    /* ------------------------------------------------------------ */
    private static final aMultiMap<Class<?>, Method> class2Value = new aMultiMap<>();
