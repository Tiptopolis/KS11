...
public class CookieCompliance implements ComplianceViolation.Mode {
	...
	public enum Violation implements ComplianceViolation {
		 ...
		 */
		COMMA_NOT_VALID_OCTET("https://tools.ietf.org/html/rfc6265#section-4.1.1",
				"Comma not valid as cookie-octet or separator"),

		/**
		 * Allow cookies to have $ prefixed reserved parameters
		 */
		RESERVED_NAMES_NOT_DOLLAR_PREFIXED("https://tools.ietf.org/html/rfc6265#section-4.1.1",
				"Reserved names no longer use '$' prefix");
	...
	/**
	 * A CookieCompliance mode that enforces
	 * <a href="https://tools.ietf.org/html/rfc6265">RFC 6265</a> compliance.
	 */
	public static final CookieCompliance RFC6265 = new CookieCompliance("RFC6265", noneOf(Violation.class));

	/**
	 * A CookieCompliance mode that allows
	 * <a href="https://tools.ietf.org/html/rfc2965">RFC 2965</a> compliance.
	 */
	 ...
	 * <dl>
	 * <dt>0</dt>
	 * <dd>No {@link CookieCompliance.Violation}s</dd>
	 * <dt>*</dt>
	 * <dd>All {@link CookieCompliance.Violation}s</dd>
	 * <dt>&lt;name&gt;</dt>
	 * <dd>The name of a static instance of CookieCompliance (e.g.
	 * {@link CookieCompliance#RFC6265}).
	 * </dl>
	 * <p>
	 * The remainder of the list can contain then names of
	 * {@link CookieCompliance.Violation}s to include them in the mode, or prefixed
	 * with a '-' to exclude them from the mode. Examples are:
	 * </p>
	 * <dl>
	 * <dt>{@code 0,RESERVED_NAMES_NOT_DOLLAR_PREFIXED}</dt>
	 * <dd>Only allow
	 * {@link CookieCompliance.Violation#RESERVED_NAMES_NOT_DOLLAR_PREFIXED}</dd>
	 * <dt>{@code *,-RESERVED_NAMES_NOT_DOLLAR_PREFIXED}</dt>
	 * <dd>Allow all violations, except
	 * {@link CookieCompliance.Violation#RESERVED_NAMES_NOT_DOLLAR_PREFIXED}</dd>
	 * <dt>{@code RFC2965,RESERVED_NAMES_NOT_DOLLAR_PREFIXED}</dt>
	 * <dd>Same as RFC2965, but allows
	 * {@link CookieCompliance.Violation#RESERVED_NAMES_NOT_DOLLAR_PREFIXED}</dd>
	 * </dl>
	 *
