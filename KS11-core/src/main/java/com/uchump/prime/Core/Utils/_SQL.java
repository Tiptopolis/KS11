...
public class _SQL {
	...
	public static aMap<String, Class> SQL_JAVA = new aMap<String, Class>();
	public static aSetMap<String, Supplier> SQL_TYPES = new aSetMap<String, Supplier>();
	...
	public static enum Type implements iEnum<Type>, iPrimitive {
		...
		SMALLINT(Short.class, _Lambda.instanceOf(Short.class, Integer.class, Long.class), (() -> {
			return (short) 0;
		}), "EXACT", "NUMERIC"), //
		INTEGER(Integer.class, _Lambda.instanceOf(Integer.class, Long.class, Short.class), (() -> {
			return 0;
		}), "EXACT", "NUMERIC"), //
		BIGINT(Long.class,
				_Lambda.instanceOf(Long.class, Short.class, Integer.class, long.class, short.class, Integer.class),
				(() -> {
					return (long) 0;
				}), "EXACT", "NUMERIC"),
		DECFLOAT(Float.class, _Lambda.instanceOf(Float.class, Double.class, double.class, float.class), (() -> {
			return (float) 0;
		}), "APROX", "NUMERIC"),
		DOUBLE(Double.class, _Lambda.instanceOf(Double.class, Float.class, double.class, float.class), (() -> {
			return (double) 0;
		}), "APROX", "NUMERIC"),
		CHAR(Character.class, _Lambda.instanceOf(String.class, CharSequence.class, char.class), (() -> {
			return ' ';
		}), "CHARACTER", "STRING"), VARCHAR(String.class,
				_Lambda.instanceOf(String.class, CharSequence.class, Character[].class, char[].class), (() -> {
					return " ";
				}), "CHARACTER", "STRING", "TEXT"),
		BINARY(byte[].class, _Lambda.instanceOf(String.class, CharSequence.class, Character[].class, char[].class,
				Integer[].class, int[].class), (() -> {
					return new byte[0];
				}), "BINARY", "STRING"),
		GRAPHIC(String.class, _Lambda.instanceOf(String.class, CharSequence.class, Character[].class, char[].class,
		...
		public static aMap<Type, String> Tags;
		...
		public static void reg(Type y, String... tags) {
			if (_SQL.SQL_TYPES == null)
				_SQL.SQL_TYPES = new aSetMap<String, Supplier>();

			if (Tags == null)
				Tags = new aMap<Type, String>();
		...
		@Override
		public aMap<Type, String> getTags() {
			return Tags;
		}
